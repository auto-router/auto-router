...
class AuthService {
    ...
    async logout() {
        try {
            ...
            // Also call the OAuth logout endpoint to clear backend session
            await fetch(`${API_BASE_URL}/oauth/logout/google`, {
                method: 'GET',
...
// Add Credits link to the navigation menu

// Update the navigation items to include:
